...
const ServerError = () => {
  return (
    <div className="bg-white h-auto sm:h-[450px] mt-[40px] container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
      <h1 className="text-red-600 text-4xl sm:text-5xl md:text-6xl font-bold text-center my-8">
        500 ERROR
      </h1>
      <div className="bg-white w-full sm:w-4/5 h-auto p-4 border border-gray-300 rounded-lg mx-auto">
        <h2 className="text-red-600 text-base sm:text-lg md:text-xl leading-snug mb-4">
        ...
        <div className="flex flex-row w-full h-auto items-center mb-4">
          <svg
          ...
          <p className="ml-2 inline-block text-base sm:text-lg leading-normal">
            Refresh the page
          </p>
        </div>
        <div className="flex flex-row w-full h-auto items-center mb-4">
